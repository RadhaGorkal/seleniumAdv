...
public class CreateCampaignWithMandatoryDetailsTest extends BaseClass{
		...
		@org.testng.annotations.Test(groups = "SmokeTestCase")
		public void createCampaignTest(WebDriver driver) throws EncryptedDocumentException, IOException, InterruptedException 
		{
