...
public class Createcampaignwithcloseddate {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		Thread.sleep(1000);
		driver.findElement(By.name("campaignName")).sendKeys("Vernacampai");
		driver.findElement(By.name("targetSize")).sendKeys("3");
		
		 LocalDate closeDate = LocalDate.now().plusDays(5);
	        String formattedDate = closeDate.format(DateTimeFormatter.ofPattern("06/25/2025"));
	        driver.findElement(By.name("expectedCloseDate")).sendKeys(formattedDate);
